 ...
 * 
 *    I thought toUpperCase would title case the string, oops
 * 
 * 
...
/**
 * Returns the string with spaces... foo -> f o o
 * @param str The string with spaces in between chars
 */
function spacer(str) {
  return new Promise(function(resolve, reject) {
      setTimeout(function() {
      if (typeof str === 'string') {
          resolve(str.split('').join(' ')); // hello -> h e l l o
      } else {
          reject('Argument to uppercaser must be string');
      }
      }, 1500);
