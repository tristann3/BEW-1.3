 ...
 * 
 *    Async/Await waits on the async function to finish
 *    The return type is a Promise object
 * 
 * 
 ...
 * 
 *    the greet() and uppercaser() functions are ran and returns the string instead of the Promise object
 * 
 * 
...
/**
  * Asynchronously returns a string with spaces in between characters.
  * @param str string to be spaced.
  */
 function spacer(str) {
  return new Promise(function(resolve, reject) {
    setTimeout(function() {
